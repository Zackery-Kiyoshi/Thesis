...
object StreamMain {
  def simpleListTest():ParallelGraph={
    var func1 = "(2+3)*3"
    var graph1:StreamGraph = StreamGraph(false)
...
//    */
  ...
  def simpleFuncTest():ParallelGraph={
    ...
    var graph1:StreamGraph = StreamGraph()
  ...
  def fibRec(i:Int, g:StreamGraph = StreamGraph(false), cur:Int = 0):StreamGraph={
